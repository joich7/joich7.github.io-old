        ...
        <div className="container m-5 text-light ">
          <div className="row m-5 text-center justify-content-center">
            <div className="col-8 faded-Dark rounded">
              ...
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi in eos soluta magni sunt est excepturi voluptatum dicta inventore, impedit similique, deserunt sint illo fugit magnam, obcaecati quasi nisi at.</p>
            </div>
          </div>
